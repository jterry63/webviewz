  ...
  loadWidget() {
    ...
    return (
      ...
      <WebView
        ...
        originWhitelist={['atrium://', 'mx://', 'https://int-widgets.moneydesktop.com', 'https://widgets.moneydesktop.com']}
        onShouldStartLoadWithRequest={request => {
          ...
          return request.url
        } else if (request.mainDocumentURL.startsWith("atrium://") || request.mainDocumentURL.startsWith("mx://")) {
